		...
		<main id="guide">
			...
			<section>
				...
				<Typography variant="body1" gutterBottom>
					...
					thrilled to help, and everyone will have the chance to learn along with you!
				</Typography>
			</section>
			<section>
				<Typography variant="h4" gutterBottom>
				...
				<ul>
					...
					<li>
						Wednesday and Friday have leggacy contracts. Wednesday has a non-PE contract, and Friday
						has a PE contract.
					</li>
					<li>
			...
			<section>
				...
				<ul>
					<li>
						...
						expectations. Do not share your co-op code or set the co-op to public - this can result
						in Majeggstics getting kicked from our co-ops and makes extra work for tokens.
						<ul>
					...
					<ul>
						<li>
							There is currently a known bug when joining co-ops - you appear joined on your device,
							but not on the Egg Inc servers. Please confirm your game is in sync with the server by
							checking the eicoop link in your co-op thread <em>before boosting.</em>
						</li>
					</ul>

					<li>
						Wonky groups members together to ensure we have balanced teams. You must join the co-op
						you are assigned to. If you:
						<ul>
			...
			<section>
				...
				<ul>
					...
					<li>
						Equip your best <b>Ship in a Bottle (SIAB)</b> to help your co-op mates earn more money.
					...
					<ul>
						<li>
							Sending tokens to another player lowers their contract teamwork score - be thoughtful
							when sending tokens, and do not spam send individual tokens. Consider if your teammate
							has already boosted and how many tokens an AFK player will return to before you send
							tokens.
						</li>
				...
				<ul>
					<li>
						...
						<ul>
							...
							<li>
								Players with Tier 4 Artifacts can often use <b>two Epic Tachyon Prisms</b> (together
								or separately) to fill habs over 50%.{' '}
							</li>
							<li>
					...
					<li>
						...
						advantage of the Internal Hatchery Calm Epic Research. If needed, equip a <b>gusset</b>{' '}
						to increase hab space.
					</li>
				</ul>
			</section>
			<section>
				...
				<ul>
					<li>
						<b>Tachyon Deflectors</b> boost your co-op mates&apos; laying rates - since Majeggstics
						aim for equal contributions, a deflector will benefit your co-op overall more than any
					...
					<li>
						...
						<ul>
							<li>
								...
								the server for us to see your earnings before minimums are checked. Please check-in
								15 minutes before your minimum check and confirm your lay rate using the eicoop link
								in your thread to avoid getting a strike.
							</li>
						</ul>
					</li>
					<li>
			...
			<section>
				...
				<ul>
					...
					<li>
						<b>Staying to socialize</b> - If you quit playing but enjoy the community, you can stay
						in the group. You don’t have to play Egg Inc, and we enjoy having friends!
					</li>
				</ul>
			</section>
			<section>
				...
				<ul>
					...
					<li>
						Majeggstics is a friendly and caring group of people, but we are limited in the support
						...
						<ul>
							...
							<li>
								...
								of mental illness/madness, Disability, trauma, & neurodivergence.{' '}
							</li>
						</ul>
					</li>
					<li>
