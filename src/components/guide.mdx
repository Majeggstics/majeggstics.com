...
[mj-contracts-fl]: https://discord.com/channels/455380663013736479/1077337689281531944/1262876745930117180
...
[epicresearch]: /images/infographics/Maj_EpicResearch_full.jpg

<h1 id="welcome">
	<Icons.Maj /> Majeggstics Guide & Rule Book! <Icons.Maj />
</h1>
...
<mark>Fastlane</mark> and get access to <mark>Fast Runs</mark> you need to meet specific high-tier
artifact requirements which target more advanced players. In a <mark>Fast Run</mark> you are
expected to join faster, fill habs quicker and have a specific contribution or higher, just to name
a few rules.
...
readily available in the pins under <mark>[\#mj-contracts][mj-contracts-fl]</mark>.
...
<mark>[\#mj-announcements][mj-announcements]</mark>. You can also run the `/getminimums` command for
the contract and the Majeggstics group. Minimums are measured at 12 and 24 hours after contract
start.**
...
<div class="advicebox">
	**Tokens** <Icons.Token />
	are the human players who manage the Majeggstics&thinsp;&mdash;&thinsp;we recruit new members,
	help people play the game more efficiently, start and add people to co-op groups, and confirm
	everyone has met the minimum required laying rate for each contract. You can see someone is a
	Token by the little token icon <Icons.Token />
	next to their name. Other groups have Tokens too, so check for the "Maj Initiator" or "Maj Leader"
	server roles! <br /> <br /> You may also see people with a different icon next to their name. (
	<Icons.OldToken /> ) Nowadays these are used for a different purpose within wonky groups and most
	of them are not a member of the Maj leadership team. Double check for the Maj Initiator and Maj
	Leader server roles if in doubt!
</div>
...
<div class="advicebox">
	...
	`mj-support` in your co-op thread and a support Token <Icons.Token />
...
channels. The group would be thrilled to help, and everyone will have the chance to learn along with
you!
...
<table>
	...
	<tbody>
		<tr>
			...
			<td class="time">17:00 (5:00 pm)</td>
		</tr>
		<tr>
...
Late registrations may be accepted in <mark>[\#mj-contracts][mj-contracts]</mark> (for <mark>ULTRA <Icons.Ultra /></mark> contracts in <mark>[\#mj-ultra][mj-ultra]</mark>)
...
<div class="alertbox">
	...
	the minimum for the previous time slot. Check the message that pinged you in the co-op thread to
...
<div class="alertbox">
	...
	device, but not on the Egg Inc servers. Please confirm your name appears in the memberlist of your
	co-op ingame and your game is in sync with the server by checking the `eicoop` link in your co-op
	thread **before boosting**.
</div>
...
<Anchored anchor="start_your_farm" h2="Start and grow your contract farm" />
...
3. Use a <mark>Soul Mirror</mark> if you can't finish your common research or buy large
   ...
   - The person in your contract with the highest EB will have a soul mirror icon
     ...
     next to their name in your Discord thread. Ask them kindly to equip their best EB artifacts,
     but remember that they are just other players, and have no more obligation to reply or do as
     requested than you do, especially if they're busy.
   - If you are struggling despite the <Boost.Image boost={Boost.Mirror} />
     <mark>Soul Mirror</mark>, you can use
     <img
     	src="/images/gameResources/boosts/Boosts_Jimbos_Excellent_Bird_Feed_short.png"
     	title="3x Jimbos Birdfeed"
     	class="icon"
     />
     <img
     	src="/images/gameResources/boosts/Boosts_Jimbos_Premium_Bird_Feed_short.png"
     	title="10x Jimbos Birdfeed"
     	class="icon"
     />
     <img
     	src="/images/gameResources/boosts/Boosts_Jimbos_Best_Bird_Feed_short.png"
     	title="50x Jimbos Birdfeed"
     	class="icon"
     />
...
<div class="advicebox">
	While using a <mark>Soul Mirror</mark>, EB increasing _artifacts_ have no effect. Swap your{' '}
	<mark>Book of Basan</mark>, <mark>Soul Stones</mark> and <mark>Prophecy Stones</mark> for things
	like the <mark>Vial of Martian Dust</mark>, <mark>Shell Stones</mark>, or{' '}
	<mark>Terra Stones</mark>.
</div>

4. Send <mark>Chicken Runs</mark> every 3 hours to help your co-op mates grow their farms.

5. Request or send _tokens_ <Icons.OldToken /> to other co-op members upon request.
   - Be thoughtful when sending tokens, and do not spam send individual tokens. Consider if your teammate has already boosted and how many tokens an AFK player will return to before you send tokens.
...
<div class="advicebox">
	Do not underestimate <mark>Epic Research</mark> in your boosting. Make sure to follow the{' '}
	<mark>[Epic Research Buying Order][epicresearch]</mark> and once you have at least one level of
...
<mark>Large Tachyon Prisms</mark> (500 GE per) for your minimums. Remember to use a
<Boost.Image boost={Boost.Mirror} /> <mark>Soul Mirror</mark>
before and after your Tachyons. It's a good and cheap boosting pattern, however it will be
outmatched very quickly.
...
- Slower / cheaper version for max habs: <Boost.Image boost={Boost.LegendaryTach} />
  <mark>Legendary Tachyon Prism</mark> + 2x <Boost.Image boost={Boost.Beacon} />
  <mark>Boost Beacon</mark> (11.600 GE total)
- Requires good artifacts and Dilithium set and maxed Epic Research to max: <Boost.Image
...
Before boosting, you can extend the duration of boosts if you equip artifacts with <mark>Dilithium Stones</mark> in them. Immediately after starting your boosts, switch to your best
...
farm (either close the app or swap to your homefarm) to take advantage of the
<mark>Internal Hatchery Calm</mark> Epic Research. If needed, equip a<mark>Gusset</mark> to increase
hab space.
...
<div class="advicebox">
	**Check in regularly and don't let your chickens fall asleep!** The game does not update when
	closed. You must open your co-op farm and sync with the server for your earnings to be counted by
	the game. Please check-in 15 minutes before your minimum check and confirm your lay rate using the
	eicoop link in your thread to avoid getting a strike. If you experience issues with syncing the
	game, please contact `mj-support` for help.
</div>
...
<Anchored anchor="freestyle" h2="(Re-)running your own contracts within Majeggstics" />
...
<div class="alertbox">
	We only allow co-ops for a contract to be posted in <mark>[\#mj-freestyle][mj-freestyle]</mark>{' '}
	once all Majeggstics timeslots have passed. Posting before that may result in the message being
	deleted and a warning given.
</div>
...
<div class="alertbox">
	...
	you may receive a warning from our Tokens <Icons.Token />. These warnings are to be taken
	seriously&thinsp;&mdash;&thinsp;if you continue with the behavior you will eventually get removed
	from Majeggstics without a chance to rejoin.
</div>
...
1. Follow server <mark>[\#rules][rules]</mark>. Majeggstics members and channels must follow the Egg, Inc. server rules (this includes but is not limited to always watermarking your prest screenshots). Violating server rules will lead to removal from Majeggstics and the Egg, Inc. server.
...
9. You will be removed from Majeggstics for glitching/cheating not only in our co-ops but also other parts of the game.
   - Server staff may be notified of cheating players and may apply server-wide penalties.
...
13. Direct Messages (DM)
    ...
    - If you see inappropriate chat in Majeggstics channels, or glitching in our co-ops,
      ...
      <Icons.Token />. Wonky will automatically remove your reaction to protect your privacy, and
      Tokens <Icons.Token /> will get a copy of the message.
...
2. [Ciria's Useful Links Pin in <mark>\#the_majeggstics</mark> ↗](https://discord.com/channels/455380663013736479/807641608538292254/1121583305410740314)
...
it you'll receive a confirmation message in the channel from Wonky, the bot who helps run our co-ops.
