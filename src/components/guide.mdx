...
<div class="advicebox">
    **Tokens** <Icons.Token />
    ...
    next to their name. Other groups have Tokens too, so check for the "Maj Initiator"
    or "Maj Leader" server roles!
</div>
...
<div class="alertbox">
    ...
    device, but not on the Egg Inc servers. Please confirm your name appears in the memberlist of your co-op ingame and your game is in sync with the server by
...
farm (either close the app or swap to your homefarm) to take advantage of the <mark>Internal Hatchery Calm</mark> Epic Research. If needed, equip a
